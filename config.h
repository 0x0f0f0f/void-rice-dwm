...
#define NUMCOLORS 9
char *colors[NUMCOLORS][MAXCOLORS] = {
    // border	 	foreground	  background
    { "#111111",	 "#ffffff", 	  "#111111" },  // 0 = normal
    { "#222222", 	 "#ffffff", 	  "#444444" },  // 1 = selected
    { "#111111", 	 "#ffffff", 	  "#da846b" },  // 2 = urgent
    { "#111111", 	 "#ffffff", 	  "#222222" },  // 3 = occupied
    { "#111111", 	 "#111111", 	  "#e7ab65" },  // 4 = yellow
    { "#111111", 	 "#ffffff", 	  "#268ac3" },  // 5 = blue
    { "#111111", 	 "#ffffff", 	  "#9977a2" },  // 6 = magenta
    { "#111111", 	 "#ffffff", 	  "#6d966c" },  // 7 = cyan
    { "#111111",	 "#ffffff", 	  "#222222" },  // 8 = grey
};
...
ResourcePref resources[] = {
	{ "font",         STRING,  &fonts[0] },
        ...
        { "background",   STRING,  &colors[3][0] },
        { "background",   STRING,  &colors[4][0] },
        { "background",   STRING,  &colors[5][0] },
        { "background",   STRING,  &colors[6][0] },
        { "background",   STRING,  &colors[7][0] },
        { "background",   STRING,  &colors[8][0] },

        { "foreground",   STRING,  &colors[0][1] }, // Foreground
        { "background",   STRING,  &colors[1][1] },
        { "foreground",   STRING,  &colors[2][1] },
        { "foreground",   STRING,  &colors[3][1] },
        { "foreground",   STRING,  &colors[4][1] },
        { "foreground",   STRING,  &colors[5][1] },
        { "foreground",   STRING,  &colors[6][1] },
        { "foreground",   STRING,  &colors[7][1] },
        { "foreground",   STRING,  &colors[8][1] },

        { "background",   STRING,  &colors[0][2] }, // Background
        { "foreground",   STRING,  &colors[1][2] }, // selected
        { "color1",       STRING,  &colors[2][2] }, // urgent
        { "color8",       STRING,  &colors[3][2] }, // occupied
        { "color3",       STRING,  &colors[4][2] }, // yellow
        { "color4",       STRING,  &colors[5][2] }, // blue
...
static const char *dmenucmd[]   = { "dmenu_run", "-i", "-l", "20", "-p", "Search >", "-fn", "cherry:style=Regular:size=10" , "-nb", "#111111", "-nf", "#ffffff", "-sb", "#444444", "-sf", "#ffffff", "-w", "0", "-h", "20", NULL };
